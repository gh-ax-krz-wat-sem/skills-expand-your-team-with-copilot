document.addEventListener("DOMContentLoaded", () => {
  ...
  const difficultyLevels = {
    Beginner: { label: "Beginner", color: "#c8e6c9", textColor: "#2e7d32" },
    Intermediate: { label: "Intermediate", color: "#fff9c4", textColor: "#f57c00" },
    Advanced: { label: "Advanced", color: "#ffccbc", textColor: "#d84315" },
  };
  ...
  function renderActivityCard(name, details) {
    ...
    const difficultyBadge = details.difficulty_level ? `
      <span class="difficulty-badge" style="background-color: ${difficultyLevels[details.difficulty_level].color}; color: ${difficultyLevels[details.difficulty_level].textColor}">
        ${difficultyLevels[details.difficulty_level].label}
      </span>
    ` : "";
